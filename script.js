    ...
    return `
      <article class="trip-card" id="trip-card-${trip.id}">
        <div class="trip-card-image">
          <img src="${trip.image}" alt="${trip.title}" loading="lazy" referrerPolicy="no-referrer" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=800&q=80';">
...
window.openTripModal = function(tripId) {
  ...
  modalBody.innerHTML = `
    <div style="margin-bottom: 20px;">
      <img src="${trip.image}" alt="${trip.title}" style="width:100%; height:260px; object-fit:cover; border-radius:var(--radius-md); border:1px solid var(--color-border);" referrerPolicy="no-referrer" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=800&q=80';">
...
function renderSliderGallery(gallery) {
  ...
  track.innerHTML = gallery.items.map((item, index) => `
    <div class="slide-item">
      <img src="${item.image}" alt="${item.title}" loading="lazy" referrerPolicy="no-referrer" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=800&q=80';">
